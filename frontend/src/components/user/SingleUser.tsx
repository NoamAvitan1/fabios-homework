...
export const SingleUser = ({ user,updateUser }: Props) => {
  ...
  return (
    <div className="SingleUser">
      <button onClick={()=>setIsOpen(true)} className="edit">עריכה</button>
      <Modal isOpen={isOpen} setIsOpen={setIsOpen}>
        ...
        <div className="inputFields">
          <div className="input-section">
                <input defaultValue={user?.customer} {...register("customer",{
              ...
              <div className="input-section">
                <input defaultValue={user?.branch} placeholder="מטבח מקומי"
                  {...register("branch",{
              ...
              <div className="input-section">
                <input defaultValue={user?.date} {...register("date",{
              ...
              <div className="input-section">
                <input defaultValue={user?.time} placeholder="14:24" {...register("time",{
      ...
      <section className="user-section">
          {labels.map((label,i) => (
            <p key={i} className="labelInfo">{label}:</p>
          ))}
      </section>
      <section className="user-section">
          <p>{user?.customer}</p>
